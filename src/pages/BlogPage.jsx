      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            Stories, tips and insights about organic products and the culture of Gilgit-Baltistan.
          </p>
        </header>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className="p-8 flex flex-col">
                  ...
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">
                    <Link to={`/blog/${filteredPosts[0].id}`} className="hover:text-green-600">
                      {filteredPosts[0].title}
                    </Link>
                  </h3>

                  <p className="text-gray-600 mb-6 flex-1">{filteredPosts[0].excerpt}</p>
        ...
        {filteredPosts.length === 0 && (
          <section className="text-center py-16">
            ...
            <p className="text-gray-600">Try adjusting your search or choose a different category.</p>
          </section>
        )}
        ...
        <section className="mt-16 bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl p-8 text-center text-white">
          ...
          <p className="text-green-100 mb-6 max-w-2xl mx-auto">
            Subscribe for the latest articles and product updates from Baltistan.
          </p>
          <form className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            <label htmlFor="bp-news" className="sr-only">Email</label>
            <input id="bp-news" type="email" placeholder="Enter your email" className="flex-1 px-4 py-3 rounded-lg text-gray-800 focus:outline-none focus:ring-2 focus:ring-green-300" />
            <button type="button" className="bg-white text-green-600 px-6 py-3 rounded-lg font-semibold hover:bg-green-50 transition-colors duration-200">
              Subscribe
            </button>
          </form>
        </section>
